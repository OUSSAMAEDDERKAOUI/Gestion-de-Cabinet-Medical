...
<body>
    ...
    <main class="redirection flex justify-center drop-shadow-2xl items-center h-screen relative ">
        <div class="absolute inset-0">
            <img src="../../storage/images/FemmeMG_Blog-Grand_800x300_2021 (1) (1).png" alt="Background Image" class="object-cover w-full h-full ">
        </div>
        ...
        <div class="max-w-md w-full space-y-8 bg-white p-8 rounded-lg shadow-lg animate__animated animate__fadeIn">
            ...
            <form method="POST" id="loginForm" class="mt-8 space-y-6">
            <?php if (!empty($errors)) : ?>  <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
                ...
                <div class="rounded-md shadow-sm flex flex-col gap-5">
                    <div>
                        ...
                        <input id="email" name="email" required class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-purple-500 focus:border-purple-500 focus:z-10 sm:text-sm" placeholder="Adresse email">
                    </div>
                    <div>
