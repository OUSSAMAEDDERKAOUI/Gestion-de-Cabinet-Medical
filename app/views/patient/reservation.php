...
<head>
    ...
    <title>Réservations - SantéPlus</title>
...
<body class="min-h-screen flex flex-col bg-gray-50">
            ...
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    <a href="index.html" class="flex items-center">
                        ...
                        <span class="ml-2 text-xl font-semibold">SantéPlus</span>
                    </a>
                </div>

                <div class="hidden md:flex items-center space-x-4">
                    <a href="./client.php" class="text-gray-700 hover:text-blue-700 px-3 py-2">Dashboard</a>
                    <a href="./logout.php" class="text-gray-700 hover:text-blue-700 px-3 py-2">déconnexion</a>
    ...
    <main class="flex-grow pt-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <h1 class="text-3xl font-bold text-gray-900 mb-8">Nos medecins</h1>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                while ($rows = $result->fetch_assoc()) {
                    ...
                    echo " <img src='./images/istockphoto-1142192548-612x612.jpg'alt='Me. Jean Dupont 'class='w-full h-48 object-cover'>";
                    echo '<div class="p-6">';
    ...
    <footer class="bg-gray-800 text-white">
        <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    <h3 class="text-lg font-semibold mb-4">SantéPlus</h3>
                    <p class="text-gray-400">Expertise medicale professionnelle à votre service.</p>
                </div>
                <div>
